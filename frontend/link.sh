...
tar -xf ../../../supertokens-auth-react/supertokens-auth-react-*.tgz --strip-components=1 -C node_modules/supertokens-auth-react
rm ../../../supertokens-auth-react/supertokens-auth-react-*.tgz
...
ln -s ../../../supertokens-auth-react/node_modules/supertokens-web-js node_modules/supertokens-web-js

# We symlink the supertokens-website dep to ensure it's the same version (maybe linked locally)
ln -s ../../../supertokens-auth-react/node_modules/supertokens-website node_modules/supertokens-website
